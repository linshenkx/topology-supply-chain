...
export const R3_COMMANDS = Object.freeze({
...
export type R3CommandName = (typeof R3_COMMANDS)[keyof typeof R3_COMMANDS];

export const R3_COMMAND_RESOURCES: Readonly<Record<R3CommandName, string>> = Object.freeze({
...
export const r3CommandHeadersSchema = commandHeadersSchema;
...
export const r3CommandResponseSchema = {
  type: "object",
  additionalProperties: false,
  ...
  properties: {
    command: {
      ...
      properties: {
        command: { enum: Object.values(R3_COMMANDS) },
